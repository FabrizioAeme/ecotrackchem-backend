 ...
 * 400 (validacion), 404 (recurso no encontrado), 409 (conflicto de datos),
 * 401 (credenciales invalidas) y 500 (cualquier otro error no controlado).
 */
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // 409 - Conflicto de integridad de datos (ej. codigo/correo duplicado)
