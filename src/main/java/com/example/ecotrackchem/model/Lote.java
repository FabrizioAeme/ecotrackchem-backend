...
/**
 * Registro de la produccion/sintesis de un producto especifico.
 * Relaciona al usuario que autoriza la produccion con el insumo
 * quimico principal utilizado, y es el origen de los residuos
 * industriales generados durante el proceso.
 */
@Entity
@Table(name = "lotes")
@Getter
